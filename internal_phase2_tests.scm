...
(define proc4 (divide-checked '/ 2 integer? 'integer /))
(assert-equal (proc4 'call global-env 3 4) (/ 3 4))
(assert-equal (proc4 'call global-env 'x 'y) (/ 3 -1))
(assert-error (proc4 'call global-env 1 0))  ; divide by zero
